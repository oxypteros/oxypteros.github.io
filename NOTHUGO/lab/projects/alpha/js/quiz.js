...
let quiz = (
  <div className="quiz">
    ...
    <div className="answers b2">
      <ol>
        <li>This is the first Answer</li>
        <li>This is the second Answer</li>
        <li>This is the third Answer</li>
        <li>This is the fourth Answer</li>
      </ol>
    </div>
  </div>
      );
...
import quizData from "js/quizdata.js";
...
const nextQuestion = () => {
    ...
    if (questionCount > unAnsweredQuestion.length - 1) {
        // Stop timer
        startTimer("stop");
        const timerData = document.querySelector('.timer span').textContent;p
